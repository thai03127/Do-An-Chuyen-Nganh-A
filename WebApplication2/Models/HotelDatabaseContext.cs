...
public partial class HotelDatabaseContext : DbContext
{
    ...
    public virtual DbSet<QldichvuPhong> QldichvuPhongs { get; set; }

    public virtual DbSet<TienIchPhong> TienIchPhongs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity.HasOne(d => d.MaLoaiNavigation).WithMany(p => p.Bookings)
        ...
        modelBuilder.Entity<Checkin>(entity =>
        {
            ...
            entity.HasOne(d => d.MaBookingNavigation).WithMany(p => p.Checkins)
                .HasForeignKey(d => d.MaBooking)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Checkin_Booking");

            entity.HasOne(d => d.MaPhongNavigation).WithMany(p => p.Checkins)
        ...
        modelBuilder.Entity<HinhAnh>(entity =>
        {
            ...
            entity.HasOne(d => d.MaLoaiNavigation).WithMany(p => p.HinhAnhs)
                .HasForeignKey(d => d.MaLoai)
        ...
        modelBuilder.Entity<QldichvuPhong>(entity =>
        {
            ...
            entity.HasOne(d => d.MaDvNavigation).WithMany(p => p.QldichvuPhongs)
                .HasForeignKey(d => d.MaDv)
                .HasConstraintName("FK_QLdichvu_phong_Dichvu");

            entity.HasOne(d => d.MaPhongNavigation).WithMany(p => p.QldichvuPhongs)
                .HasForeignKey(d => d.MaPhong)
        ...
        modelBuilder.Entity<TienIchPhong>(entity =>
        {
            ...
            entity.HasOne(d => d.MaLoaiNavigation).WithMany(p => p.TienIchPhongs)
                .HasForeignKey(d => d.MaLoai)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_TienIchPhong_LoaiPhong");

            entity.HasOne(d => d.MaTnNavigation).WithMany(p => p.TienIchPhongs)
